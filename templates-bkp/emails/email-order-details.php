...
//Output the email header
 ...
 <p><?php printf( __( 'You have received an order from %s. The order is as follows1231:', 'woocommerce' ), $order->get_formatted_billing_full_name() ); ?></p>
    ...
    <table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
        <thead>
            <tr>
				...
				<th class="td" scope="col" style="text-align:<?php echo $text_align; ?>;"><?php _e( 'Admin Id', 'woocommerce' ); ?></th>
